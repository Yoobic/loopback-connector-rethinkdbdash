...
RethinkDB.prototype.createAllPromise = function createAllPromise(model, filter, options) {
    options = options || {};
    filter = filter || {};
    var _this = this;
...
RethinkDB.prototype.allFeed = function(model, feedId, filter, callback) {
    ...
    var promise = this.createAllPromise(model, filter);
